...
#define GST_ROS_BASE_SINK(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GST_TYPE_ROS_BASE_SINK, RosBaseSink))
#define GST_ROS_BASE_SINK_CAST(obj) ((RosBaseSink *)obj)
#define GST_ROS_BASE_SINK_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), GST_TYPE_ROS_BASE_SINK, RosBaseSinkClass))
#define GST_ROS_BASE_SINK_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GST_TYPE_ROS_BASE_SINK, RosBaseSinkClass))
