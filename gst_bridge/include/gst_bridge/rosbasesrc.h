...
#define GST_ROS_BASE_SRC_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), GST_TYPE_ROS_BASE_SRC, RosBaseSrcClass))
#define GST_ROS_BASE_SRC_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GST_TYPE_ROS_BASE_SRC, RosBaseSrcClass))
