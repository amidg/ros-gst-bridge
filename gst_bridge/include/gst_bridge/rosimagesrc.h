...
#define GST_ROSIMAGESRC_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), GST_TYPE_ROSIMAGESRC, RosimagesrcClass))
#define GST_ROSIMAGESRC_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GST_TYPE_ROSIMAGESRC, RosimagesrcClass))
